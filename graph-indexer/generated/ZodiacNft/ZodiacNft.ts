...
export class ZodiacNft extends ethereum.SmartContract {
  static bind(address: Address): ZodiacNft {
    return new ZodiacNft("ZodiacNft", address);
  }
  ...
  getEndYear(): BigInt {
    let result = super.call("getEndYear", "getEndYear():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getEndYear(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getEndYear", "getEndYear():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getStartYear(): BigInt {
    let result = super.call("getStartYear", "getStartYear():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getStartYear(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getStartYear", "getStartYear():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_tokenURI(year: BigInt): ethereum.CallResult<string> {
